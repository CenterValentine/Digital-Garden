...
export function AdminSidebar() {
  ...
  return (
    <div className="p-4 space-y-2">
      ...
      <Link
        href="/content"
        className="flex items-center gap-2 px-3 py-2 mb-2 rounded-lg text-sm text-gray-300 hover:text-white hover:bg-white/5 transition-all"
      >
        <ArrowLeftIcon />
