...
/**
 * StaticCompactLogo - Non-animated version of CompactLogo
 *
 * Shows the completed logo state without line-drawing animation.
 * Ideal for navbar where animation on every route change would be distracting.
 */
export default function StaticCompactLogo() {
  return (
    <svg
      id="static-compact-logo"
...
`}</style>
      ...
      {/* Crown - visible at final position and scale */}
      <g
        id="journalCrown"
        style={{
          opacity: 1,
          transform: "translate(188.73px, 278.91px) scale(0.2)",
