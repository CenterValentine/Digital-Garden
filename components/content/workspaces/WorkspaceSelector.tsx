...
export function WorkspaceSelector() {
  ...
  }, [settingsWorkspace, claimConflictState, claimResolutionInFlight, nodesById, workspaces]);
  ...
  const isNodeWithinFolder = (nodeId: string, folderId: string) => {
  ...
  const buildClaimConflicts = (folderIds: string[]) => {
