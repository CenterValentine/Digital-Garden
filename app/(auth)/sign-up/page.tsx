          ...
          <div className="space-y-4 rounded-md shadow-sm">
            ...
            <div>
              ...
              <input
                ...
                className="relative block w-full border-0 px-3 py-2 bg-white dark:bg-black/30 text-gray-900 dark:text-gray-100 ring-1 ring-inset ring-gray-300 dark:ring-white/15 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
