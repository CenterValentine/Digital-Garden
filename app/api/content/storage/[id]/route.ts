...
export async function GET(
  ...
  try {
    ...
    console.error(`GET /api/content/storage/[id] error:`, error);
    return NextResponse.json(
      {
        success: false,
        error: {
...
export async function PATCH(
  ...
  try {
    ...
    console.error(`PATCH /api/content/storage/[id] error:`, error);
    return NextResponse.json(
      {
        success: false,
        error: {
...
export async function DELETE(
  ...
  try {
    ...
    console.error(`DELETE /api/content/storage/[id] error:`, error);
    return NextResponse.json(
      {
        success: false,
        error: {
