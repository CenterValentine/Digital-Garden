...
const ROUTE_PATH = "/api/content/templates/[id]";
  ...
  return withRouteTrace(request, { route: ROUTE_PATH }, async () => {
    try {
      ...
      const updated = await withSpan(
        { layer: "content", name: "template_update" },
...
export async function DELETE(
  ...
  return withRouteTrace(_request, { route: ROUTE_PATH }, async () => {
    try {
      ...
      await withSpan(
        { layer: "content", name: "template_delete" },
        { attrs: { template_id: id } },
        async () => prisma.contentTemplate.delete({ where: { id } }),
      );
