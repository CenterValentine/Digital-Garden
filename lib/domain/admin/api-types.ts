...
export const AUDIT_ACTIONS = {
  ...
  // AI run inspection
  VIEW_AI_RUN_LIST: "VIEW_AI_RUN_LIST",
  VIEW_AI_RUN_DETAIL: "VIEW_AI_RUN_DETAIL",

  // User connections
  CONNECTION_INVITE_SENT: "CONNECTION_INVITE_SENT",
  CONNECTION_INVITE_ACCEPTED: "CONNECTION_INVITE_ACCEPTED",
  CONNECTION_INVITE_DECLINED: "CONNECTION_INVITE_DECLINED",
  CONNECTION_INVITE_REVOKED: "CONNECTION_INVITE_REVOKED",
