...
**August 30, 2026**: **Database II — number formatting, column resize, context rail, AI option proposals** (branch `feat/database-ii`, PR pending; typecheck / lint / ai:drift:check green; no migration, no TipTap schema change → **no Hocuspocus redeploy**; owner smoke pending)
