...
**August 29, 2026**: **File shortcuts** (branch `feat/file-shortcuts`, PR pending; typecheck / lint 151 / full build green; ⚠ **migration `20260828120000_add_shortcut_content_type` must `migrate deploy` before any non-local env**; no TipTap schema change → **no Hocuspocus redeploy**; owner smoke passed through creation, mirroring, removal and picker parity)
