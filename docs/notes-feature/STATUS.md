...
**August 18, 2026**: **File tree Reference Drawer — referenced content nests behind a count chip; both visibility toggles removed; publish dot made meaningful** (main working tree; typecheck/lint(**ratchet lowered 159 → 149**)/**new `reference-block:check` gate**/build green; owner browser smoke pending)
