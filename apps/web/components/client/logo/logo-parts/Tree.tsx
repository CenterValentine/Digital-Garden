...
import LogoDefs from "./Logo-Defs";
...
export default function Tree() {
  ...
  useEffect(() => {
    ...
    // If you want to tweak placement, adjust these two numbers.
...
`}</style>
      ...
      {showCrown && (
        <g
          id="journalCrown"
          ref={crownRef}
          // Mount only after completion to avoid any flash during load/hydration.
          // Also start at scale(0) so it's effectively invisible until the WAAPI kicks in.
          style={{
            opacity: 0,
            transform: "scale(0)",
            pointerEvents: "none",
