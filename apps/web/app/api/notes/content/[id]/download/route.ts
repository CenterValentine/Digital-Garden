 ...
 * File Download API
 *
 * GET /api/notes/content/[id]/download - Generate download URL for uploaded files
 *
...
// ============================================================
// GET /api/notes/content/[id]/download - Download File
// ============================================================
...
export async function GET(
  ...
  try {
    ...
    console.error("GET /api/notes/content/[id]/download error:", error);
    return NextResponse.json(
      {
        success: false,
        error: {
