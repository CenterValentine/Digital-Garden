 ...
 * Content Tree API
 *
 * GET /api/notes/content/tree - Get hierarchical content tree
 *
...
// ============================================================
// GET /api/notes/content/tree - Get Content Tree
// ============================================================
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error("GET /api/notes/content/tree error:", error);
    return NextResponse.json(
      {
        success: false,
        error: {
